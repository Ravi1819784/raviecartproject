...
<div className="gadget-list">
  ...
  {fashionProduct.map((product)=>{return(  <div className="fashion-card">
    <div className="fashion-image">   <img  src={ product.Image[0]}  alt={ product.Name} className='gadget-img'/></div>
...
<div ><h6 className="fashion-heading">{ product.Heading}</h6></div>
<div className="price-gadget">
  ...
  {/* <div className="gadget-card">
    <div className="gadget-image">  
       ...
       <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT8Fettjl2rGDjHBlCYCXcWMRAoKDr_AQOoXQ&s" alt="" className='gadget-img'/></div>
...
<div className="gadget-heading"><h5>heading</h5></div>
<div className="price-gadget">
  <h6><del>₹1999</del></h6>
  <h6 style={{color:"green"}}>₹2099</h6>
</div>
    </div>
    
  </div> */}
  {/* <div className="gadget-card">
    <div className="gadget-image">   <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT8Fettjl2rGDjHBlCYCXcWMRAoKDr_AQOoXQ&s" alt="" className='gadget-img'/></div>
